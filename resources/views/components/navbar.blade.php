...
<navbar
    ...
    <a class="flex flex-col items-center justify-center {{request()->is('/') ? 'text-indigo-500':'text-zinc-500'}}" href="/">
    ...
    <a class="flex flex-col items-center justify-center {{request()->is('history') ? 'text-indigo-500':'text-zinc-500'}}" href="/history">
    ...
    <a class="flex flex-col items-center justify-center {{request()->is('categories') ? 'text-indigo-500':'text-zinc-500'}}" href="/categories">
        <svg class="w-8 h-8" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
            height="24" fill="none" viewBox="0 0 24 24">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <a class="flex flex-col items-center justify-center {{request()->is('preset') ? 'text-indigo-500':'text-zinc-500'}}" href="/preset">
