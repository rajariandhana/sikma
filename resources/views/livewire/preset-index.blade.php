<div class="flex flex-col gap-y-2">
    @forelse ($presets as $preset)
        <div class="flex items-center justify-between w-full">
            ...
            <div class="flex gap-x-2">
                <button wire:click="PresetShow({{ $preset }})" class="px-2 py-2 bg-white rounded-md shadow-md">
    ...
    @if ($form=='create')
        <x-modal-form title="Create preset">
            <x-slot:body>
                <div class="mb-5">
    ...
    @elseif ($form=='editing')
        <x-modal-form title="Edit preset">
            <x-slot:body>
                <div class="mb-5">
                    <label for="price" class="block mb-2 text-sm font-medium text-gray-900 ">Preset price</label>
                    <input type="text"disabled wire:model="price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                </div>
                <div class="mb-5">
                    <label for="category_id" class="block mb-2 text-sm font-medium text-gray-900 ">Preset category</label>
                    <input type="text"disabled wire:model="category_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                </div>
            </x-slot:body>
            <x-slot:footer>
